...
class BalzacCalltoAction extends WP_Widget{
	...
	public function __construct(){
		parent::__construct(
			...
			'BalzacCalltoAction',
			__('Balzac - Call to action', 'balzac'),
			array('description'=>__('Add a call to action in the sidebar.', 'balzac'))
		);
	}
	...
	public function form($instance){
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'description' ); ?>"><?php _e( 'Call to action incentive:', 'balzac' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php _e( 'Call to action destination (url):', 'balzac' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'label' ); ?>"><?php _e( 'Button\'s label:' , 'balzac' ); ?></label> 
 ...
 * @return void
 */
if (!function_exists('balzac_calltoaction_widget_init')){

	function balzac_calltoaction_widget_init(){
	
		register_widget('BalzacCalltoAction');
	}
}
add_action('widgets_init', 'balzac_calltoaction_widget_init');
